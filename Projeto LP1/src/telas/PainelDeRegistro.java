...
public class PainelDeRegistro extends javax.swing.JInternalFrame {
   //CONSTRUTORES:
    ...
    public PainelDeRegistro() {
      ...
      *      seria feito em dois. Assim (Painel de Cadastro e Painel de  
      *      Edição tornaram-se o Painel de Registro.
      */ 
   ...
   //MÉTODOS:
    ...
    private void initComponents() {
      ...
      *    Descrição:
      *      Ao assinalar o botão é definido que não há registro fotográfico
      *      da obra em questão e é atribuído a ela uma imagem específica 
      *      indicando isso (not_available).
      */
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        if (jCheckBox1.isSelected()) {
            img = ManipulaçãoDeImagem.setImagemDimensao("src\\imagens\\not_available.jpg", 160, 160);
        ...
        if (painelEditor == false) {
            ...
            if (null != verifica) {
                ...
                if (!existeNaListaTombo(a.getTombo())) {
                    ...
                    limpa_campos();
                    PainelPergunta painelPer = new PainelPergunta();
               ...
               for (Arte e : cad) {
                if (t == e.getTombo()) {
                    ...
                    if (checkbIndeterminado.isSelected()) {
                        e.setPeriodoProducao("Indeterminado");
                    } else {
